...
class SwipeReply {
  ...
  final String? emoji; // optional decorative emoji
  ...
  /// Build from plain string (backward-compat with old List<String>)
...
class SwipeReplyCards extends StatefulWidget {
  /// List of plain reply strings (converted internally to SwipeReply)
  final List<String> replies;
  final Future<void> Function(String reply) onSend;
  final VoidCallback onCancel;

  /// Optional: incoming message text shown as context at the top
...
class _SwipeReplyCardsState extends State<SwipeReplyCards>
  ...
  static const double _maxAngle = 0.15; // radians

  @override
  void initState() {
    super.initState();

    _cards = widget.replies
        .asMap()
        .entries
        .map((e) => SwipeReply.fromString(e.value, e.key))
        .toList();
  ...
  Widget _buildCardStack() {
    ...
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          // Background cards (static, scaled down)
