    ...
    return AnimatedBuilder(
      ...
      builder: (_, __) => Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: const Color(0xFF69F0AE).withOpacity(0.5 * _ctrl.value),
              blurRadius: 6,
              spreadRadius: 1,
            ),
          ],
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
            color: const Color(0xFF66BB6A).withOpacity(0.35), width: 1),
      ),
        ...
        children: [
          AnimatedBuilder(
            ...
            builder: (_, __) => Container(
              ...
              decoration: BoxDecoration(
                shape: BoxShape.circle,
                color: _C.white.withOpacity(0.08 + pulseAnim.value * 0.12),
                border: Border.all(
                  color: _C.white.withOpacity(0.2 + pulseAnim.value * 0.25),
                  width: 1.5,
                ),
              ),
      ...
      builder: (_, __) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border(
              bottom: BorderSide(color: _C.teal.withOpacity(0.2 + t * 0.25)),
            ),
          ),
          child: Row(
            children: [
              Container(
                ...
                height: 36,
                decoration: BoxDecoration(
                  color: _C.teal.withOpacity(0.1 + t * 0.08),
                  borderRadius: BorderRadius.circular(10),
                  border: Border.all(color: _C.teal.withOpacity(0.3 + t * 0.3)),
                ),
                child: Icon(Icons.shield_rounded,
                    color: _C.teal.withOpacity(0.8 + t * 0.2), size: 19),
              ),
              const SizedBox(width: 10),
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text('🔒 Bảo mật đầu cuối',
                        style: TextStyle(
                            color: _C.teal.withOpacity(0.7), fontSize: 10)),
                  ],
                ),
              ),
              buildButtons(onMinimize: onMinimize, onClose: onClose),
