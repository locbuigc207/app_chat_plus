...
/// • Game Center integration (Invite & Result cards)
...
class _AdaptiveChatBubbleState extends State<AdaptiveChatBubble>
  ...
  void initState() {
    ...
    // Game messages do not need AI scan
    if (!_isMe &&
  ...
  Widget build(BuildContext context) {
    ...
    // ── Game messages: render without swipe animation & reactions ─────────
    // Game cards cannot be replied to, forwarded, or reacted to
        ...
        child: Column(
          ...
          children: [
            ...
            if (isExpanded) ...[
              ...
              const Text(
                'Hệ thống AI phát hiện tin nhắn này có thể là lừa đảo. '
