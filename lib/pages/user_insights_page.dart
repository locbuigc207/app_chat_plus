...
class _UserInsightsPageState extends State<UserInsightsPage>
  ...
  Future<void> _load() async {
    ...
    _animCtrl.reset();
    try {
      final result = await AIBackendService().getUserInsights(
  ...
  Widget _buildLoading(ThemePalette p, ThemeProvider theme) => Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              'Đang xử lý lịch sử trò chuyện của bạn',
  ...
  Widget _buildError(ThemePalette p, ThemeProvider theme) => Center(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(fontSize: 13, color: p.textHint, height: 1.5),
              ),
              const SizedBox(height: 20),
              FilledButton.icon(
                onPressed: _load,
  ...
  Widget _buildNoData(ThemePalette p) => Center(
        child: Padding(
          padding: const EdgeInsets.all(32),
          child: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              Container(
                ...
                child: Icon(
                  ...
                  size: 56,
                  color: p.textHint.withValues(alpha: 0.5),
                ),
              ),
              const SizedBox(height: 20),
              Text(
              ...
              Text(
                ...
                textAlign: TextAlign.center,
                style: TextStyle(fontSize: 13, color: p.textHint, height: 1.6),
              ),
            ],
          ),
        ),
      ...
      children: [
        ...
        _InsightCard(
          ...
          content: switch (r.communicationStyle) {
            'formal' =>
              'Trang trọng & lịch sự — bạn thường dùng ngôn ngữ chuẩn mực, kính trọng và súc tích',
            'casual' =>
              'Thoải mái & thân thiện — bạn nói chuyện tự nhiên, vui vẻ và gần gũi',
            _ =>
              'Linh hoạt theo tình huống — bạn dễ dàng thay đổi phong cách phù hợp ngữ cảnh',
          },
