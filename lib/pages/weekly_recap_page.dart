...
class WeeklyRecapPage extends StatelessWidget {
  ...
  Widget _buildEmpty(ThemePalette p, ThemeProvider theme) => Center(
        child: Padding(
            ...
            children: [
              Container(
                ...
                child: Icon(Icons.analytics_outlined,
                    size: 56, color: p.textHint.withValues(alpha: 0.45)),
              ),
              ...
              Text(
                ...
                style:
                    TextStyle(fontSize: 13.5, color: p.textHint, height: 1.6),
              ),
  ...
  Widget build(BuildContext context) => Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Expanded(
              child: Text(
                'AI phân tích tự động mỗi tuần. Dữ liệu được ẩn danh và xử lý an toàn trước khi gửi đến AI.',
