...
class _GameSetupPageState extends State<GameSetupPage> {
  ...
  Future<void> _onCreate() async {
    ...
    try {
      ...
      final boardSize = _gameType == GameType.caro ? (_boardMode == 1 ? 3 : 0) : 0;
      final turnTimer = _gameType == GameType.caro ? AppConstants.caroTurnTimers[_turnTimerIndex] : 0;
      final timeControl = _gameType == GameType.chess ? AppConstants.chessTimeControls[_timeControlIndex] : 0;
      ...
      final timeControlLabel = _gameType == GameType.chess
          ...
          : (turnTimer > 0 ? AppConstants.caroTurnTimerLabels[_turnTimerIndex] : '');
