...
class GroupChatPageState extends State<GroupChatPage>
  ...
  // Bộ đệm chặn trùng lặp tin nhắn
  ...
  void _readLocal() {
    ...
    // [SỬA LỖI P0: Memory Leak] — Gán và dọn dẹp listener an toàn
  ...
  // [SỬA LỖI P1: Performance] — Thay vì await trong vòng lặp, dùng Future.wait
  ...
  Future<void> _scheduleMessage() async {
    ...
    _showToast(
      '📅 Lên lịch lúc ${DateFormat('HH:mm').format(time)}',
      isSuccess: true,
    );
  }
...
// =============================================================================
// DATE DIVIDER — Sticky pill style
// =============================================================================
