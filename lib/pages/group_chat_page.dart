...
class GroupChatPageState extends State<GroupChatPage> {
  ...
  void _onSendMessage(String content, int type) {
    if (content.trim().isNotEmpty) {
      ...
      // Send group message
      _sendGroupMessage(content, type);
    ...
    return FutureBuilder<DocumentSnapshot>(
      ...
      builder: (_, senderSnapshot) {
        ...
        if (senderSnapshot.hasData && senderSnapshot.data != null) {
          final sender = UserChat.fromDocument(senderSnapshot.data!);
