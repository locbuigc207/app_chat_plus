...
class _WaitingRoomPageState extends State<WaitingRoomPage>
  ...
  Widget _buildTopBar() => Row(children: [
        ...
        CallTimerWidget(
          ...
          style: const TextStyle(
              color: _K.muted, fontSize: 13, letterSpacing: 0.8),
        ),
      ]);
    ...
    return Stack(alignment: Alignment.center, children: [
      ...
      Container(
        decoration: BoxDecoration(
          shape: BoxShape.circle,
          boxShadow: [
            BoxShadow(color: _K.amber.withValues(alpha: 0.25), blurRadius: 32),
          ],
        ),
        child: CircleAvatar(
          radius: 54,
      ...
      Positioned(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(color: _K.amber.withValues(alpha: 0.4), blurRadius: 10)
            ],
          ),
  ...
  Widget _buildStatus() => Column(children: [
  ...
  Widget _buildWaitingDots() => AnimatedBuilder(
        ...
        builder: (_, __) {
          return Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            Text('Đang chờ được cho vào',
                style: TextStyle(
                    color: _K.muted.withValues(alpha: 0.8), fontSize: 12)),
  ...
  Widget _buildCallInfo() => Container(
        ...
        child: Row(children: [
          ...
          Column(
              ...
              children: [
                const Text('Được tổ chức bởi',
                    style: TextStyle(color: _K.muted, fontSize: 9)),
                Text(_model.initiatorName,
                    style: const TextStyle(
                        color: _K.amber,
                        fontSize: 11,
                        fontWeight: FontWeight.w700)),
  ...
  Widget _buildParticipantPreview() {
    ...
    return Column(mainAxisSize: MainAxisSize.min, children: [
      Text('${_model.participantCount} người đang trong phòng',
          style: const TextStyle(color: _K.muted, fontSize: 12)),
      const SizedBox(height: 10),
      Row(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...shown.asMap().entries.map((e) => Transform.translate(
...
class _OrbsPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size s) {
    canvas.drawRect(
        Rect.fromLTWH(0, 0, s.width, s.height), Paint()..color = _K.bg);
